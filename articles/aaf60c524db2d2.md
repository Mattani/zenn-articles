...
会社のセキュリティガイドラインで、「ログイン失敗を複数回繰り返すとアカウントロックするしくみを有すること」という項目があり、Redmineの標準ではそんな機能ないなーとおもって調査していたところ、[Redmine Login Attempts Limit](https://github.com/xmera-circle/redmine_login_attempts_limit)のプラグインを見つけましたので紹介いたします。
...
このプラグインは、[midnightSuyama版](https://github.com/midnightSuyama/redmine_login_attempts_limit)がオリジナルで、[RegioHelden版](https://github.com/RegioHelden/redmine_login_attempts_limit)→現在の[xmera-circle版](https://github.com/xmera-circle/redmine_login_attempts_limit)へのフォークされています。
...
詳細は[ドキュメント](https://circle.xmera.de/projects/redmine-login-attempts-limit/wiki)をご確認ください。

## Redmine5や6で動くか？問題

結論。RedMica 3.2.4(based on Redmine 6.0.6.devel)とRedmine 5.1.3の環境で試しましたがちゃんと動きました。
